...
/* Generated from: address9.proto */

#ifndef PROTOBUF_C_address9_2eproto__INCLUDED
#define PROTOBUF_C_address9_2eproto__INCLUDED
...
typedef enum _Tutorial__MyEnum {
  TUTORIAL__MY_ENUM__A = 0,
  TUTORIAL__MY_ENUM__B = 2,
  TUTORIAL__MY_ENUM__C = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(TUTORIAL__MY_ENUM)
} Tutorial__MyEnum;
...
extern const ProtobufCEnumDescriptor    tutorial__my_enum__descriptor;
...
#endif  /* PROTOBUF_C_address9_2eproto__INCLUDED */
